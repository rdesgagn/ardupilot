...
#define XCKJ_MAX_ESC 8
    ...
    Canard::Publisher<com_xckj_esc_ThortGroup1> esc_xckj_throtgroup1{ canard_iface };
    Canard::Publisher<com_xckj_esc_ThortGroup2> esc_xckj_throtgroup2{ canard_iface };
    ...
    Canard::Subscriber<com_xckj_esc_OperateId> esc_xckj_OperateId_listener{ handle_xckj_OperateId_cb, _driver_index };
