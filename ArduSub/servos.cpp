...
void Sub::update_servos() {
    ...
    float servo1_output = SRV_Channels::get_output_scaled(SRV_Channel::Aux_servo_function_t::k_actuator1);
    printf("servo1 = %f, read value  = %f\n", aux_actuator_value[0], servo1_output);
}
